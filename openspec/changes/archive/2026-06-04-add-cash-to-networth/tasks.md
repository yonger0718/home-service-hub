...
## 7. Frontend — networth chart two-line overlay
...
- [x] 7.3 Dashboard spec: chart datasets array has length 2 with `scales.y.stacked = false`; switching window preserves the two-dataset layout
